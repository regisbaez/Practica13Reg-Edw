        ...
        <section class="hero text-center">
            <div class="container-sm">
                <div class="hero-inner">
                    ...
                    <canvas id="temperatura" width="400" height="400"></canvas>
...
<script>
    ...
    let temp = document.getElementById("temperatura").getContext('2d');
    let humedad = new Chart(ctx, {
        type: 'line',
        data: {
            labels:[new Date()],
            datasets:[{data: 0}]
    ...
    let temperatura = new Chart(temp, {
        type: 'line',
        data: {
            labels:[new Date()],
            datasets:[{data: 0}]
    ...
    function actualizar(datos) {
        ...
        addData(humedad, moment(nuevo.fecha, "YYYY-MM-D HH:mm:ss"), nuevo.humedad);
        addData(temperatura, moment(nuevo.fecha, "YYYY-MM-D HH:mm:ss"), nuevo.temperatura);
